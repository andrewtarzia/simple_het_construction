...
def heteroleptic_cages() -> abc.Sequence[tuple[str, str]]:
    return (
        ("l1", "la"),
        ("l1", "lb"),
        ("l1", "lc"),
...
def ligand_cage_topologies() -> dict[str, abc.Sequence[str]]:
    return {
...
def erxn_cage_topologies() -> dict[str, str]:
    return {
        "l1": "m6",
        "l2": "m12",
        "l3": "m24",
...
class M30L60(stk.cage.Cage):
    def _get_scale(self, building_block_vertices) -> float:  # noqa: ANN001, ARG002
        return 0.7
